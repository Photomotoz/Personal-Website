...
function loadLevel(location){
	console.log("Loading level : " + location);
	jQuery(function() {
		...
		u.initPlugin(jQuery("#unityPlayer")[0], location.toString());
	});
}
;
